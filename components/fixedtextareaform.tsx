        ...
        toast({
            ...
            description: (
                <pre className="mt-2 w-[340px] rounded-md bg-slate-950 p-4">
                    <code className="text-white">{JSON.stringify(textAreaValue, null, 2)}</code>
                </pre>
            ),
        })
    }
            ...
            <form
                        ...
                        <FormItem className="flex-grow">
                            <FormControl>
                                <Textarea
                                    ...
                                    className="resize-none w-full  pr-44"
                                    {...field}
                                    value={textAreaValue}
                                    onChange={(e) => {
                                        field.onChange(e);
                ...
                <div>
                    ...
                    <Button
                        variant="sky"
                        type="submit"
                        className="absolute hover:bg-sky-600 right-0 top-0 mr-3 mt-2"
